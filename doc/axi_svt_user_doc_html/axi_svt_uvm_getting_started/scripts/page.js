...
// Page
var SSIFrame = window.top.document.querySelector('.page_display_iframe');
var SSIFrameWindow = null;
if (SSIFrame) {
    SSIFrameWindow = SSIFrame.contentWindow || SSIFrame;
}
...
Page.OnLoad = function (param_event_or_redirect_url) {
    ...
    if ((Page.window === Page.window.top || Page.window == SSIFrameWindow) && (Page.window.navigator.userAgent.indexOf('bot/') === -1)) {
        // Redirect
        //
